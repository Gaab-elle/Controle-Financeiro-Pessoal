  ...
  <div class="min-h-screen bg-white">
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
      <div class="max-w-md w-full">
        <h2 class="text-4xl font-semibold text-center mb-8" style="color: #1F2937;">Cadastro</h2>
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          <div>
            <label class="block text-sm font-medium mb-2" style="color: #6B7280;">Nome</label>
            <input
              v-model="form.name"
              type="text"
              required
          ...
          <div>
            <label class="block text-sm font-medium mb-2" style="color: #6B7280;">Confirmar Senha</label>
            <input
